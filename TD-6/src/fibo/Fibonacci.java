...
public class Fibonacci {
	...
	private static Map<Integer, Integer> cachedResultByN;
	
	static{
		cachedResultByN = new HashMap<>();
		cachedResultByN.put(0, 0);
		cachedResultByN.put(1, 1);
	}
...
//		System.out.println("invocation fibonacci() avec n=" + n);
		...
		if (cachedResultByN.containsKey(n)){
			return cachedResultByN.get(n);
		}
		
		int newResult = fibonacci(n - 1)  + fibonacci(n - 2);
		cachedResultByN.put(n, newResult);
		return newResult;
